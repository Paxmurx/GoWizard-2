...
function Title() {
  return (
    <div
      ...
      data-name="Title"
    >
      <p className="font-['Inter:Bold',sans-serif] font-bold leading-[30px] md:leading-[54px] not-italic relative shrink-0 text-[#18181c] text-[28px] md:text-[44px] text-center tracking-[-1px] w-full px-4 md:px-0">
  ...
  return (
    ...
    >
      <motion.p 
        ...
        className="font-['Inter:Regular',sans-serif] font-normal leading-[16px] not-italic relative shrink-0 text-[#565660] text-[12px] text-nowrap whitespace-pre"
      >
        Advertorial
      </motion.p>
      <motion.div
  ...
  return (
    ...
    >
      ...
      >
        <img
          alt=""
          className="absolute inset-0 max-w-none object-50%-50% object-cover pointer-events-none size-full mix-blend-multiply"
